...
/// </summary>
/// <remarks>
///     The class restricts to CommandParsing implementations on purpose as to force the user to at least have support for
///     -h.
///     However, in order to discourage users from just passing that class when they see the error, this separate class was
///     developed.
